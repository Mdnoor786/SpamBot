...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"✨ ʐɨռɖǟ ɦօօ ֆɨʀ✨!\n`{ms}` 𝗺𝘀\n {PM} ")
...
Mᴀsᴛᴇʀ:-** **[м∂ иσσя \~🇮🇳](t.me/SimpleBoy786)**
...
async def Start_Kardo_Bot():
  await event.client.send_message("LionXSupport", "**I'm Ready For Spamming...! 🎉**")
